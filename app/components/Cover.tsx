...
const Cover = ({}: Props) => {
	...
	return (
		<div
			className="w-full h-96 flex flex-col items-center justify-center gap-5 bg-center text-white
		bg-[url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&q=80&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=2070')]">
			...
			<div className="w-[808px] h-14 rounded-lg bg-[#FFFFFF] text-[#C4C4C4] flex items-center p-3 gap-2">
